...
import os  # needed to pull values from environmental variables
...
SECRET_KEY = 'django-insecure-cun&o((jc12igg#%c!6+)l7*e_v5!=#(!1l@wq4nx=+(k!wu+p'
...
# To enable image uploads to work through browsable interface.
